...
class Sorted_List:
    ...
    def __contains__(self, key):
        ...
        item = 0
        while (item < length) == True and self._values[item] != key:
            item += 1
    ...
    def combine(self, source1, source2):
        ...
        if len(source1._values) > len(source2._values):
            while len(source2._values) > 0:
                self._values.append(source1.remove(source1._values[0]))
                self._values.append(source2.remove(source2._values[0]))
            self._values.append([i for i in source1])

        elif len(source2._values) > len(source1._values):
            while len(source2._values) > 0:
                self._values.append(source1.remove(source1._values[0]))
                self._values.append(source2.remove(source2._values[0]))
            self._values.append([i for i in source2])
    ...
    def find(self, key):
        ...
        length = len(self._values)
        i = 0
        while (i < length) == True and self._values[i] != key:
            i += 1
        if i == length:
            value = None
        else:
    ...
    def is_identical(self, target):
        ...
        -------------------------------------------------------
        """
        if [i for i in self._values] == [i for i in target]:
            identical = True
        else:
            identical = False
    ...
    def split(self):
        ...
        length = len(self._values)
        if length % 2 == 0:
            target1.insert(self._values[:int(length / 2)])
            target2.insert(self._values[int(length / 2):])
        else:
            target1.insert(self._values[:int((length + 1) / 2)])
            target2.insert(self._values[int((length + 1) / 2):])
    ...
    def split_key(self, key):
        ...
        found = self._values.index(key)

        target1.insert(self._values[:found])
        target2.insert(self._values[found:])
